...
- 📦🆓 [ThreatCluster](https://github.com/Jam0k/Threat-Intelligence-MCP) — Clustered incident records from 20,000+ sources, validated IOCs, CVE lookup and ransomware leak-site victims. 10 tools. Free tier works without a key; `THREATCLUSTER_API_KEY` only raises the daily limit. `npx -y threatcluster-mcp`.
